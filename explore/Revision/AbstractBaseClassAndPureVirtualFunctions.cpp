...
public:
    ...
    virtual void display() = 0; // pure virtual function (do nothing function) // this is now abstract base class, as the function needs to be OVERRIDEN. we can't create objects of abstract base class.
};
